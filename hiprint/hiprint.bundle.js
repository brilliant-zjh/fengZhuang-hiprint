...
var hiprint = function (t) {
    ...
    var _r,
        ...
        Dt = function () {
            ...
            }, t.prototype.getValue = function () { }, t.prototype.setValue = function (t) {
                t && 1 == t.length && (this.target.find("ul").html(t[0].map(function (t, e) {
                    return '<li class="hiprint-option-table-selected-item"> ' + e + "</li>";
                }).join("")), this.target.find("li").hidraggable({
                    revert: !0,
                    moveUnit: "pt",
                    deltaX: 0,
                    deltaY: 0
                    ...
                    onDrop: function onDrop(t, e) {
                        $(e).insertAfter(this), $(this).css("border-bottom-color", "");
                    }
                }));
            }, t.prototype.destroy = function () {
                this.target.remove();
        ...
        Bt = function () {
            ...
            }, t.printElementOptionItems = [new H(), new I(), new S(), new F(), new O(), new D(), new B(), new R(), new z(), new L(), new A(), new N(), new k(), new j(), new V(), new W(), new M(), new X(), new G(), new U(), new q(), new Y(), new J(), new Q(), new K(), new Z(), new tt(), new et(), new nt(), new it(), new ot(), new rt(), new at(), new pt(), new st(), new lt(), new ut(), new ht(), new dt(), new ct(), new ft(), new gt(), new vt(), new mt(), new yt(), new bt(), new Tt(), new wt(), new Pt(), new Et(), new xt(), new Ct(), new Ot(), new Ht(), new It(), new St(), new Ft(), new Dt()], t;
        }(),
        Rt = function () {
            return function (t) {
        ...
        $t = function (t) {
            ...
            return _t(e, t), e.prototype.getPrintElementOptionEntity = function () {
                var t = [];
                return this.columns.forEach(function (e) {
                    t.push(e.getEntity());
                }), t;
        ...
        Gt = function (t) {
            function e(e, n) {
                ...
                return console.log(n), i.options = new Mt(n), i.options.setDefault(new Mt(p.instance.table.default).getPrintElementOptionEntity()), i;
            }
            ...
            return Xt(e, t), e.prototype.updateDesignViewFromOptions = function () {
                ...
                return i.append(Nt.createTableHead(this.printElementType.columns, this.options.getWidth())), i.append(Nt.createTableRow(this.printElementType.columns, t, this.options, this.printElementType)), this.printElementType.footerFormatter && i.append(Nt.createTableFooter(this.printElementType.columns, t, this.options, this.printElementType)), i;
                ...
                t.prototype.updateSizeAndPositionOptions.call(this, r, o, i, n), Nt.resizeTableCellWeight(this.designTarget, this.printElementType.columns, this.options.getWidth());
        ...
        Jt = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new jt(n), i.options.setDefault(new jt(p.instance.image.default).getPrintElementOptionEntity()), i;
            }

            return Yt(e, t), e.prototype.getReizeableShowPoints = function () {
                return ["se"];
            }, e.prototype.getData = function (t) {
                var e = "";
        ...
        Kt = function (t) {
            ...
            return Qt(e, t), e.prototype.getHideTitle = function () {
        ...
        ee = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new Kt(n), i.options.setDefault(new Kt(p.instance.longText.default).getPrintElementOptionEntity()), i;
            }

            return te(e, t), e.prototype.getDesignTarget = function (e) {
                ...
                this.createTempContainer();
                var e = this.getPaperHtmlResult(new Zt("", 1e3, 1e3, 0, 25e3, 0, 0, !0, void 0, 0, void 0), {}, t);
        ...
        oe = function (t) {
            function e(e) {
                var n = t.call(this, e) || this;
                return n.title && (n.title = ne.replaceEnterAndNewlineAndTab(n.title, "")), n;
            }

            return ie(e, t), e.prototype.getHideTitle = function () {
                return null == this.hideTitle ? this.defaultOptions.hideTitle : this.hideTitle;
        ...
        ae = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new oe(n), i.options.setDefault(new oe(p.instance.text.default).getPrintElementOptionEntity()), i;
            }

            return re(e, t), e.prototype.getDesignTarget = function (e) {
                ...
                return t && (t = ne.replaceEnterAndNewlineAndTab(t, "")), t;
            }, e.prototype.getData = function (t) {
                return t ? t[this.getField()] || "" : this.options.testData || this.printElementType.getData() || "";
        ...
        ue = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new se(n), i.options.setDefault(new se(p.instance.html.default).getPrintElementOptionEntity()), i;
            }
        ...
        de = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new jt(n), i.options.setDefault(new jt(p.instance.vline.default).getPrintElementOptionEntity()), i;
            }
        ...
        fe = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new jt(n), i.options.setDefault(new jt(p.instance.hline.default).getPrintElementOptionEntity()), i;
            }
        ...
        ve = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new jt(n), i.options.setDefault(new jt(p.instance.rect.default).getPrintElementOptionEntity()), i;
            }
        ...
        ye = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new jt(n), i.options.setDefault(new jt(p.instance.oval.default).getPrintElementOptionEntity()), i;
            }

            return me(e, t), e.prototype.updateDesignViewFromOptions = function () {
                if (this.designTarget) {
                    var t = this.getData();
                    this.css(this.designTarget, t);
                }
        ...
        be = function () {
            ...
            return t.createPrintElement = function (t, e) {
                return "text" == t.type ? new ae(t, e) : "image" == t.type ? new Jt(t, e) : "longText" == t.type ? new ee(t, e) : "table" == t.type ? new Gt(t, e) : "html" == t.type ? new ue(t, e) : "vline" == t.type ? new de(t, e) : "hline" == t.type ? new fe(t, e) : "rect" == t.type ? new ve(t, e) : "oval" == t.type ? new ye(t, e) : void 0;
            }, t;
        }(),
        Te = function () {
            function t(t) {
            ...
            return t.prototype.getText = function (t) {
                ...
                var e = {};
                return $.extend(e, t || {}), be.createPrintElement(this, e);
            }, t.prototype.getPrintElementTypeEntity = function () {
                return new Ut({
                    title: this.title,
                    type: this.type
        ...
        Ie = function () {
            ...
            return t.getColumnsWidth = function (e, n) {
                ...
                for (var i = e || new He(), o = function o(e) {
        ...
        Se = function () {
            ...
            return t.prototype.init = function () {
                ...
                Ie.resizeTableCellWeight(this.rows);
                ...
                }), this.target.before(i), this.cgripContariner = new Ce(i, n);
                ...
                }), this.target.before(i), this.rgripContariner = new Ce(i, n), this.syncRowGrips();
        ...
        Fe = function () {
            function t(t) {
                this.id = b.createId(), this.optionsCoat = new Pe(t), this.handle = t.handle, this.target = t.table, this.initRows(t.rows), this.init(t), this.tableCellSelector = new g(this.rows, this.target), this.resizer = new Se(this), this.resizer.init();
            }
            ...
            return t.prototype.insertRow = function (t, e, n) {
                ...
                var t = this.tableCellSelector.getSingleSelect(),
                    e = this.getCellGrid(),
                    n = Ee.getIndex(e[t.rowIndex], t.cell.id);

                if (t) {
                    for (var i = t.rowIndex; i < t.rowIndex + t.cell.rowspan; i++) {
                        for (var o = this.rows[i], r = i == t.rowIndex ? t.cell : Ee.getLeftTableCell(e[i], n), a = 0; a < t.cell.colspan; a++) {
        ...
        Be = function (t) {
            ...
            return De(e, t), e.prototype.getPrintElementOptionEntity = function () {
        ...
        Le = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new Be(n), i.options.setDefault(new Be(p.instance.tableCustom.default).getPrintElementOptionEntity()), i.columns = i.options.columns, i;
            }

            return ze(e, t), e.prototype.updateDesignViewFromOptions = function () {
                if (this.designTarget) {
                    this.css(this.designTarget, this.getData());
                    var t = this.designTarget.find(".hiprint-printElement-table-content"),
                        e = this.getHtml(this.designPaper);
        ...
        Ne = function (t) {
            ...
            return Ae(e, t), e.prototype.createPrintElement = function (t) {
        ...
        je = function (t) {
            ...
            return ke(e, t), e.prototype.createPrintElement = function (t) {
                var e = {};
                return $.extend(e, t || {}), be.createPrintElement(this, e);
        ...
        Ve = function () {
            ...
            return t.createPrintElementType = function (t) {
                return t.type = t.type || "text", "text" == t.type ? new je(t) : "table" == t.type ? new qt(t) : "tableCustom" == t.type ? new Ne(t) : new Te(t);
            }, t;
        }(),
        _e = function () {
            function t() { }
        ...
        $e = function () {
            return function (t, e) {
                ...
                this.name = t, this.printElementTypes = [], e.forEach(function (t) {
                    n.printElementTypes.push(Ve.createPrintElementType(t));
                });
            };
        }(),
        We = function () {
        ...
        Me = function () {
            ...
            return t.prototype.design = function (t) {
                ...
                this.printElements = [], t && t.forEach(function (n) {
                    ...
                    if (i = n.printElementType ? Ve.createPrintElementType(n.printElementType) : a.instance.getElementType(n.tid)) {
                ...
                var n = new Zt(this.templateId, this.width, this.height, this.paperHeader, this.paperFooter, this.paperNumberLeft, this.paperNumberTop, this.paperNumberDisabled, this.paperNumberFormat, t, e);
                ...
                var e;
                return (e = t.tid ? a.instance.getElementType(t.tid) : Ve.createPrintElementType(t.printElementType)) || console.log("miss " + JSON.stringify(t)), e;
            ...
            return function (t) {
                if (t) if (t.panels) {
                    ...
                    for (var e = 0; e < t.panels.length; e++) {
                        this.panels.push(new We(t.panels[e]));
                    }
                } else this.panels = [];
            };
        }(),
        ...
        qe = function () {
            function t(t) {
                ...
                var n = t || {};
                this.printPanels = [];
                var i = new Xe(n.template || []);
                n.template && i.panels.forEach(function (t) {
                    e.printPanels.push(new Me(t, e.id));
                }), n.fields && (this.fields = n.fields), n.settingContainer && new Ge(this, n.settingContainer), n.paginationContainer && (this.printPaginationCreator = new Ue(n.paginationContainer, this), this.printPaginationCreator.buildPagination()), this.initAutoSave();
            }
            ...
            return t.prototype.design = function (t, e) {
                ...
                var n = t ? new Me(new We(t), this.id) : this.createDefaultPanel();
